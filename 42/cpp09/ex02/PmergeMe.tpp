...
void insert(Container& c, int level, int& comparisons)
{
	...
	c.clear();
	push_to_container2<Container, Container2>(main, c); // Both main and pend are already pushed to the result c container
	push_to_container<Container>(remainder, c); // Is this not appended to the end?
