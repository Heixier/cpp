...
int main(void)
{
	...
	const AAnimal& indirect_dog = Dog();
	// const AAnimal direct_dog = Dog(); // abstract class cannot be accessed
	...
	AAnimal* catdog = new Cat(*static_cast<Cat *>(modify_dog));
